...
--TICKET--
INSERT INTO user("first_name","last_name","email","password","role_id") VALUES ('rita', 'amr', 'ra', '123', 2);

--SUBSCRIPTIONS--
--ANNUAL QUARTLERY W MONTHLY
INSERT INTO subscription("sub_type","zone_id", "user_id", "no_of_tickets") VALUES ('annual', 1, 1, 100);
INSERT INTO subscription("sub_type","zone_id", "user_id", "no_of_tickets") VALUES ('quarterly', 2, 2, 50);
INSERT INTO subscription("sub_type","zone_id", "user_id", "no_of_tickets") VALUES ('monthly', 3, 4, 10);


--ZONES--
INSERT INTO zone("zone_type","price") VALUES ('9', '9')
INSERT INTO zone("zone_type","price") VALUES ('10', '10')
INSERT INTO zone("zone_type","price") VALUES ('16', '16');
